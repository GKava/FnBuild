...
import guide.battleroyale_fortnite.build.buildingguide.Fragment.AllConstructionsFragment;
import guide.battleroyale_fortnite.build.buildingguide.Fragment.Fort.FortFragment;
import guide.battleroyale_fortnite.build.buildingguide.Fragment.FragmentStairs;
import guide.battleroyale_fortnite.build.buildingguide.Fragment.Trap.TrapFragmentMenu;
        ...
        holder.mItemCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (pos==2){
                    ...
                    MainActivity.fragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, new TrapFragmentMenu())
                            .addToBackStack(null)
                            .commit();
                }
                if (pos==3){
                    ...
                    MainActivity.fragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, new FragmentStairs())
                            .addToBackStack(null)
                            .commit();
                }
            }
