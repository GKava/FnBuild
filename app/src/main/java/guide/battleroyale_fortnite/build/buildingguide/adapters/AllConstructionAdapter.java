...
public class AllConstructionAdapter extends RecyclerView.Adapter<AllConstructionAdapter.ViewHolder>  {
    ...
    public AllConstructionAdapter(int width) {
        super();
        this.width = width;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull AllConstructionAdapter.ViewHolder holder, final int position) {
...
//        holder.imageName2.setImageResource(item.getImageName2());
    ...
    @NonNull
    @Override
    public AllConstructionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.d(TAG, "onCreateViewHolder");
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_all_construction, parent, false);

        RecyclerView.LayoutParams lp = (RecyclerView.LayoutParams) view.getLayoutParams();
        lp.height = width;
        view.setLayoutParams(lp);

        return new AllConstructionAdapter.ViewHolder(view);
    }
